...
function NavBar() {
    ...
    return (
        ...
        <Navbar  expand="lg" className="bg-success position-sticky" style={{ top: 0, zIndex: "1000" }}>
          ...
          <Link  className="navbar-brand  text-black" to="/"><b>AgroMart</b>
          </Link>
            ...
            <Navbar.Collapse id="basic-navbar-nav">
                <Nav className="me-auto">
                    ...
                    {/* <Link className="nav-link text-black" to="/testimonial">TESTIMONIAL</Link> */}
                </Nav>
